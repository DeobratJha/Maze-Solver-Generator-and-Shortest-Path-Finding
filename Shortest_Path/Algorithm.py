...
class Dijkstra(Search):
    ...
    def solver(self):
        ...
        end_time = time.time()
        print(f"Dijkstra: Total Time = {end_time - start_time:.4f} seconds, Total Steps = {steps}")
...
class A_search(Search):
    ...
    def solver(self):
        self.heap = []
        self.entry_count = 1
        h_score_s2t = A_search.manhattan(self.start_node, self.target_node)
        ...
        end_time = time.time()
        print(f"A*: Total Time = {end_time - start_time:.4f} seconds, Total Steps = {steps}")
...
class BFS(Search):
    ...
    def solver(self):
        ...
        end_time = time.time()
        print(f"BFS: Total Time = {end_time - start_time:.4f} seconds, Total Steps = {steps}")
...
class Q_Learning(Search):
    ...
    def output(self):
        ...
        end_time = time.time()
        print(f"Q-Learning: Total Time = {end_time - start_time:.4f} seconds, Total Steps = {steps}")
